...
\title{\textbf{STAT 20000: Elementary Statistics} \\ \large Winter 2026}
...
To ensure a timely response, please include \textbf{[STAT 20000]} at the beginning of the subject line for all course-related emails. Emails without this tag may experience delays.
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Midterm (30\%):} Friday, 4/24, in class.
    \item \textbf{Final Exam (40\%):} In-person, per the Registrar's Office schedule. No early finals.
\end{itemize}
