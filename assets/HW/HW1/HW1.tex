...
\pagestyle{fancy}
\fancyhf{}
\lhead{STAT 2000: Elementary Statistics}
\rhead{Homework 1}
\cfoot{Page \thepage\ of \pageref{LastPage}}

% ---------- Custom Commands ----------
\newcommand{\course}{STAT 2000: Elementary Statistics}
...
\paragraph{Q4 (2 points).} (FPP Chapter 2, Review Exercise 6 on p.25-26) (Continues the previous exercise.) The second trial used what is called a “crossover” design. The subjects were assigned at random to one of four groups:\\
...
\paragraph{Q5 (5 points).} (FPP Chapter 2, Review Exercise 11 on p.27. For part (c), please give an alternative explanation for result if
